...
var _stripe = __webpack_require__(1);
...
var _ncryp = __webpack_require__(5);

var _ncryp2 = _interopRequireDefault(_ncryp);

var _handlerResponse = __webpack_require__(7);
...
var _calculations = __webpack_require__(12);
...
var _blind = __webpack_require__(6);
...
var Ncryp = function () {
  ...
  _createClass(Ncryp, [{
    ...
    value: function encryptField(value) {
      var encrypted = new _blind2.default({ encryptKey: this.encryptKey }).encrypt(value);
      return encrypted;
    }
  }, {
    key: 'decryptField',
    value: function decryptField(encryptedValue) {
      var decrypted = new _blind2.default({ encryptKey: this.encryptKey }).decrypt(encryptedValue);
      return decrypted;
    }
  }]);
