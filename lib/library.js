...
var _pmx = __webpack_require__(8);
...
var _mathjs = __webpack_require__(17);
...
exports.Email = exports.Math = exports.combinedMiddleware = exports.S3 = exports.Sequence = exports.Calculations = exports.auth = exports.HandlerResponse = exports.Ncryp = exports.Logger = exports.handlerBug = undefined;

var _handlerBug = __webpack_require__(4);

Object.defineProperty(exports, 'handlerBug', {
  enumerable: true,
  get: function get() {
    return _handlerBug.handlerBug;
  }
});
...
var _ncryp = __webpack_require__(9);

var _ncryp2 = _interopRequireDefault(_ncryp);

var _handlerResponse = __webpack_require__(11);
...
var _calculations = __webpack_require__(16);
...
var _combinedMiddleware = __webpack_require__(24);
...
var _pluginExpress = __webpack_require__(6);

var _pluginExpress2 = _interopRequireDefault(_pluginExpress);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var errorMsg = 'Class not initialized, execute init ({apiKey, projectRoot, notifyReleaseStages})';

var HandlerBug = function () {
  function HandlerBug() {
    _classCallCheck(this, HandlerBug);
  }

  _createClass(HandlerBug, [{
    key: 'init',
    value: function init(_ref) {
      var apiKey = _ref.apiKey,
          projectRoot = _ref.projectRoot,
          notifyReleaseStages = _ref.notifyReleaseStages;

      this.bugsnagClient = (0, _js2.default)({
        apiKey: apiKey, projectRoot: projectRoot, notifyReleaseStages: notifyReleaseStages
      });
      this.bugsnagClient.use(_pluginExpress2.default);
...
var handlerBug = exports.handlerBug = new HandlerBug();
...
module.exports = require("@bugsnag/plugin-express");
...
var _blind = __webpack_require__(10);
...
var Auth = function () {
  ...
  _createClass(Auth, [{
    ...
    key: 'populateUser',
    value: function populateUser(req, res, next) {
      if (req.headers['x-api-key']) {
        if (req.headers['x-api-key'] === apiKey) {
          req.user = { roles: ['api'] };
          return next();
...
var _asyncLock = __webpack_require__(19);
...
var _multer = __webpack_require__(21);

var _multer2 = _interopRequireDefault(_multer);

var _multerS = __webpack_require__(22);
...
var Email = function () {
  ...
  _createClass(Email, [{
    key: 'sendTemplate',
    value: function sendTemplate(to, templateId, substitutions) {
      var msg = {
        to: to,
        from: {
          name: this.fromName,
    ...
    key: 'sendEmail',
    value: function sendEmail(to, subject, html, attachments) {
      var msg = {
        to: to,
        from: {
          name: this.fromName,
